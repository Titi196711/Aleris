        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="count-box">
                        <i class="icofont-document-folder" style="color: #F39555;"></i><!--#c042ff-->
                        <span data-toggle="counter-up" id="chifcolor">6428</span>
                        <p>Bulletins de paye par mois</p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="400">
                    <div class="count-box">
                        <i class="icofont-live-support" style="color: #F39555;"></i><!--#46d1ff-->
                        <span data-toggle="counter-up" id="chifcolor">3800</span>
                        <p>Visites Médicales par an</p>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="600">
                    <div class="count-box">
                        <i class="icofont-users-alt-5" style="color: #F39555;"></i><!--#ffb459-->
                        <span data-toggle="counter-up" id="chifcolor">72</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up">
                    <div class="info-box">
                        <i class="bx bx-map"></i>
                        <h3></h3><!--Notre Adresse-->
                        5, rue Hans List<br>78 290 Croissy sur Seine <br>
